...
export default React.memo(MyComponent, areEqual);`}
            ...
            <div className='theme__text text'>
                <p className='text__item'>Этот метод предназначен только для оптимизации производительности.</p>
            </div>

            <div className=' theme__code code code'>
                <p className='code__title'>Аналогом в классовых компонентах выступает метод shouldComponentUpdate()</p>
                <pre className='code__item'>
